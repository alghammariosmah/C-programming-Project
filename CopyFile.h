...
void copyFile(void)//done
{
    ...
    printf("\nEnter just the name of the file you wish to copy (e.g) file.txt.\n");
    scanf("%s",file_name);
    ...
    printf("\nWrite the new name of your file or\nthe name of the directory where you want to copy your file to \n(for example) %s/Pictures/ \n", Current_path);
    ...
    {
        printf("\n%s file name already exists\nplease re_enter the name of the directory where you want to copy your file to\nor R to go back to the main menu.\n", file_name);
        scanf("%s", destination_path);//file_name
